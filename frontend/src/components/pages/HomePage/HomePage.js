...
const HomePage = () => {
  return (
    <PageTemplate 
      ...
      <Helmet>
        <title>GAZUA - 가상화폐 모의 거래소</title>
        <meta name="keywords" content="가상화폐, 암호화폐, 모의, 거래, 거래소, 비트코인, 이더리움, BTC, ETH"/>
        <meta name="description" content="가상화폐 / 암호화폐 모의 거래소 GAZUA (가즈아), 과연 당신은 가상화폐 시장에서 수익을 낼 수 있을까요? 모의거래를 통해 알아보세요."/>
      </Helmet>
      ...
      <div className={cx('block', 'responsive')}>
        <h2>GAZUA 거래소에서는, 현재 총 <b>69</b>개의 가상화폐를 지원합니다.</h2>
        <CoinMainContainer/>
      ...
      <div className={cx('footer')}>
        <div className={cx('email')}>
          <EmailIcon/> support@gazua.com
        </div>
        <div className={cx('copyright')}>
          Copyright © 2017 GAZUA
        </div>
        <div className={cx('copyright')}>
